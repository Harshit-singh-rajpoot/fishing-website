...
const Component2 = () => {
  return (
    <div className="component2">
      ...
      The input URL after being scanned is given a probability score (in the form of %). 
      This probability score has a threshold of 70%. If the score is above 70%, then the URL is highly likely to lead to a phishing attempt. 
